...
class TestFileManager(unittest.TestCase):
    ...
    def test_read_file_exists(self):
        ...
        with patch('builtins.open', mock_open(read_data=mock_json)) as mocked_file:
    ...
    def test_read_file_not_found(self):
        ...
        with patch('builtins.open', mock_open()) as mocked_file:
            ...
            mocked_file.assert_called_once_with('nonexistent_path.json', 'r', encoding='utf-8')
    ...
    def test_write_file(self):
        ...
        with patch('builtins.open', mock_open()) as mocked_file, \
            ...
            mocked_file.assert_called_once_with('dummy_path.json', 'w', encoding='utf-8')
            mocked_json_dump.assert_called_once_with(mock_data, mocked_file.return_value, indent=4)
